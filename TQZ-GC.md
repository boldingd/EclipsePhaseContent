...
Formally, every individual is an equal member of the organization; there are no ranks and there is no command structures.
...
More often, however, they get much more nebulous information — rumors, video snapshots, or curious trace evidence — and they have to infiltrate, investigate, and analyze to decide what has to be done.
...
Mars rangers, of course, vary widely: some generally support the GCs, some would be members if they could, some avoid them as often as possible, and some will shoot anyone with GC markings on sight.
(Of course, the GCs track and avoid the Rangers in the last group.)
...
They use a block-chain-like structure to host their public data (including large parts of their social network), coupled with an encrypted, secured, distributed storage system used for more sensitive data.
...
You are a trusted member of the TQZ Guard Cooperative.
...
You have been with the GCs for at least 6 months, you have been on at least 10 missions and you have scored at least one confirmed TITAN-asset kill.
...
There are several different Adjutant packages available, with different code, written by a different group, and equipped with different skills.
...
Oversight has a similar relationship: technically, the GCs are a large and well-armed organization outside of their direct control — but they’re also helping to keep the Zone secure without costing the Consortium anything, so why shut them down?
...
And this also doesn't mean that your character can't have politics or values of their own; it just means that they can't use GC equipment or GC authority for non-Coop activites.
